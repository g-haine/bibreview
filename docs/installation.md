...
BibReview **v1.5.3** requires **Python 3.12 or newer** and exposes the
...
python -m pip install "git+https://github.com/g-haine/bibreview.git@v1.5.3"

bibreview --version
~~~

The final command should report **bibreview 1.5.3**.
...
For production automation, prefer an exact release such as **v1.5.3** or an
