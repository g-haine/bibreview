...
BibReview **v1.4.1** requires **Python 3.12 or newer** and exposes the
...
The final command should report **bibreview 1.4.1**.
...
For production automation, prefer an exact release such as **v1.4.1** or an
