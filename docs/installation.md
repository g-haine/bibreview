...
BibReview **v1.2.0** requires **Python 3.12 or newer** and exposes the
...
The final command should report **bibreview 1.2.0**.
...
For production automation, prefer an exact release such as **v1.2.0** or an
