...
BibReview **v1.4.2** requires **Python 3.12 or newer** and exposes the
...
The final command should report **bibreview 1.4.2**.
...
For production automation, prefer an exact release such as **v1.4.2** or an
