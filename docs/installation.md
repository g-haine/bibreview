...
BibReview **v1.3.2** requires **Python 3.12 or newer** and exposes the
...
python -m pip install "git+https://github.com/g-haine/bibreview.git@v1.3.2"

bibreview --version
~~~

The final command should report **bibreview 1.3.2**.
...
For production automation, prefer an exact release such as **v1.3.2** or an
