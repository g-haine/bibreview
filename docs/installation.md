...
BibReview **v1.6.24** requires **Python 3.12 or newer** and exposes the
...
The final command should report **bibreview 1.6.24**.
...
For production automation, prefer an exact release such as **v1.6.24** or an
