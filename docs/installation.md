...
BibReview **v1.6.23** requires **Python 3.12 or newer** and exposes the
...
The final command should report **bibreview 1.6.23**.
...
For production automation, prefer an exact release such as **v1.6.23** or an
